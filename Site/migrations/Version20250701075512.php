 ...
 */
final class Version20250701075512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ecole (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, code_postal VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, expediteur_id INTEGER NOT NULL, destinataire_id INTEGER NOT NULL, trajet_id INTEGER NOT NULL, enfant_id INTEGER NOT NULL, contenu CLOB NOT NULL, date_envoi DATETIME NOT NULL, is_lu BOOLEAN NOT NULL, CONSTRAINT FK_B6BD307F10335F61 FOREIGN KEY (expediteur_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307FA4F84F6E FOREIGN KEY (destinataire_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307FD12A823 FOREIGN KEY (trajet_id) REFERENCES trajet (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F450D2529 FOREIGN KEY (enfant_id) REFERENCES enfant (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE trajet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, conducteur_id INTEGER NOT NULL, voiture_id INTEGER NOT NULL, ecole_id INTEGER NOT NULL, point_depart VARCHAR(255) NOT NULL, heure_depart DATETIME NOT NULL, places_disponibles INTEGER NOT NULL, statut VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, CONSTRAINT FK_2B5BA98CF16F4AC6 FOREIGN KEY (conducteur_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2B5BA98C181A8BA FOREIGN KEY (voiture_id) REFERENCES voiture (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2B5BA98C77EF1B1E FOREIGN KEY (ecole_id) REFERENCES ecole (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
